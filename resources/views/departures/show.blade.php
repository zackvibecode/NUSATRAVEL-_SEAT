    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-5">
        ...
        <div class="flex items-center gap-3">
            ...
            @if ($canManageRegs)
                ...
                <button type="button"
                        class="inline-flex items-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 text-sm font-bold rounded-full px-6 py-3 transition-all duration-150"
                        data-delete-trip
