...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
        <div>
            <h2 class="text-xl sm:text-2xl font-semibold tracking-tight">Hermes Sync</h2>
    ...
    <div class="grid lg:grid-cols-3 gap-4 mb-8">
        <div class="bg-surface rounded-xl p-6 shadow-sm border border-line lg:col-span-2">
        ...
        <div class="bg-surface rounded-xl p-6 shadow-sm border border-line">
...
5. Move file to /SeatWeb/Processed/</pre>
    ...
    <div class="bg-surface rounded-lg border border-line overflow-hidden mb-8">
