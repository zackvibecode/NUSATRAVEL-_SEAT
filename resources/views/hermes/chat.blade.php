...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-5">
        <div>
            <h2 class="font-serif text-3xl sm:text-4xl font-bold tracking-tight leading-none">Hermes Chat</h2>
    ...
    <div class="glass rounded-2xl overflow-hidden flex flex-col" style="min-height: 28rem;">
