...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
        <div>
            <h2 class="font-serif text-3xl sm:text-4xl font-bold tracking-tight leading-none">Dashboard</h2>
            <p class="text-sm text-charcoal mt-2.5">Track registrations and seat availability at a glance.</p>
        </div>
    ...
    <!-- Bento grid -->
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 auto-rows-auto">

        <!-- KPI row: 4 small cards -->
        <div class="glass rounded-2xl p-4 sm:p-5">
            <div class="flex items-center gap-2.5 mb-3">
                <div class="w-8 h-8 rounded-xl bg-brand-soft flex items-center justify-center flex-shrink-0">
        ...
        <div class="glass rounded-2xl p-4 sm:p-5">
            <div class="flex items-center gap-2.5 mb-3">
                <div class="w-8 h-8 rounded-xl bg-positive-soft flex items-center justify-center flex-shrink-0">
        ...
        <div class="glass rounded-2xl p-4 sm:p-5">
            <div class="flex items-center gap-2.5 mb-3">
                <div class="w-8 h-8 rounded-xl bg-warning-soft flex items-center justify-center flex-shrink-0">
        ...
        <!-- Chart card: spans 3 cols on lg -->
        <div class="col-span-2 lg:col-span-3 glass rounded-2xl overflow-hidden">
            <div class="px-4 sm:px-6 py-4 border-b border-white/50 flex items-center justify-between">
                <div>
                    <h3 class="font-serif text-lg sm:text-xl font-bold tracking-tight">Revenue &amp; Pax Trend</h3>
        ...
        <!-- Hermes feed: spans 1 col -->
        <div class="col-span-2 lg:col-span-1 glass rounded-2xl overflow-hidden flex flex-col">
            <div class="px-4 py-3.5 border-b border-white/50 flex items-center justify-between gap-3">
                <h3 class="font-serif text-lg font-bold tracking-tight">Hermes Update</h3>
                <a href="{{ route('hermes.updates') }}" class="text-xs font-bold text-brand hover:text-brand-hover flex items-center gap-1 flex-shrink-0">
                    View all
            ...
            <div class="divide-y divide-white/50 flex-1 overflow-y-auto max-h-64">
                ...
                @empty
                    <div class="px-4 py-10 text-center flex-1 flex flex-col items-center justify-center">
                        <div class="w-10 h-10 rounded-2xl bg-brand-soft flex items-center justify-center mx-auto mb-2.5">
        ...
        <!-- Upcoming Trips: spans 3 cols -->
        <div class="col-span-2 lg:col-span-3 glass rounded-2xl overflow-hidden">
            <div class="px-4 sm:px-6 py-4 border-b border-white/50 flex items-center justify-between">
                <div>
                    <h3 class="font-serif text-lg sm:text-xl font-bold tracking-tight">Upcoming Trips</h3>
                    <p class="text-xs text-charcoal mt-0.5 font-medium">Next 5 departures scheduled</p>
                </div>
                <a href="{{ route('departures.index') }}" class="text-xs font-bold text-brand hover:text-brand-hover flex items-center gap-1 flex-shrink-0">
                    View all
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
                    </svg>
            ...
            <div class="px-4 sm:px-6 py-4 border-b border-white/50 bg-white/20">
            ...
            <div class="p-3 sm:p-4 space-y-3">
                ...
                @empty
                    <div class="px-6 py-12 text-center">
                        ...
                        <p class="text-sm font-semibold text-ink">No upcoming departures</p>
                        <p class="text-xs text-charcoal mt-1 font-medium">Create a departure to get started.</p>
                    </div>
                @endforelse
            </div>
        </div>

        <!-- Attention trips: spans 1 col, full height -->
        <a href="{{ route('dashboard.attention-trips') }}"
           class="col-span-2 lg:col-span-1 glass rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-150 group flex flex-col">
            <div class="p-4 sm:p-5 flex-1 flex flex-col justify-between">
                <div class="w-10 h-10 rounded-xl bg-warning-soft flex items-center justify-center mb-4">
                    <svg class="w-5 h-5 text-warning" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                </div>
                <div>
                    <h3 class="font-serif text-lg font-bold tracking-tight group-hover:text-brand transition-colors">Trips Need Attention</h3>
                    <p class="text-xs sm:text-sm text-charcoal mt-1 font-medium">
                ...
                <div class="flex items-center gap-2 mt-4">
                    ...
                    @endif
                    <span class="w-9 h-9 rounded-full bg-white/60 group-hover:bg-brand group-hover:text-white text-charcoal flex items-center justify-center transition-all duration-150 ml-auto">
