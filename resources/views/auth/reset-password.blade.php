...
<head>
    ...
    <style>
        ...
        input { width: 100%; box-sizing: border-box; border: 1px solid var(--app-line); border-radius: 16px; padding: 0.875rem 1rem; font-size: 0.875rem; outline: none; transition: border-color 0.15s; margin-bottom: 1rem; background: var(--app-surface); color: var(--app-ink); }
        input:focus { border-color: var(--app-brand); }
        button[type=submit] { width: 100%; background: var(--app-brand); color: #fff; border: none; border-radius: 9999px; padding: 0.9rem; font-size: 0.875rem; font-weight: 700; cursor: pointer; margin-top: 0.25rem; }
